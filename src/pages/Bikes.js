...
// import { filterBikes } from "../utils/bikeUtils";
...
//   const filteredBikes = filterBikes(bikes, filter);
...
//         </div>
//         <div>
//           <label className="block mb-1">Current User (type "none")</label>
//           <input
//             type="text"
//             className="w-full border rounded p-2"
...
//                 <td className="p-2">
//                   <span className={
//                     b.status === "locked" ? "text-yellow-600 font-medium" :
//                     b.status === "in_use" ? "text-red-600 font-semibold" :
